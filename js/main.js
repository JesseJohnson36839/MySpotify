          ...
          <li class="song-item">
            ...
            <div>
              ...
              <div class="song-actions">
                <button onclick="playSong(${index})" class="play-btn"><i class="fas fa-play"></i></button>
                <button class="ellipsis-btn" onclick="toggleOptionsMenu(${index})"><i class="fas fa-ellipsis-h"></i></button>
              </div>
            </div>
            <ul id="optionsMenu-${index}" class="options-menu">
              <li onclick="addToQueue(${index})">Add to Queue</li>
              <li onclick="addToPlaylist(${index})">Add to Playlist</li>
            </ul>
          </li>`
          )
          .join("")}
...
function playSong(index) {
  ...
  // Ensure the selected song is different before playing
  ...
  // Play the song and update UI state
  audioPlayer.play();
  isPlaying = true;
  document.getElementById("playPauseBtn").innerHTML = '<i class="fas fa-pause"></i>';
